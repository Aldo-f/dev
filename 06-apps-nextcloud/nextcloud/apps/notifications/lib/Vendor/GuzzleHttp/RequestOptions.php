...
final class RequestOptions
{
    ...
    /**
     * body: (resource|string|null|int|float|bool|\OCA\Notifications\Vendor\Psr\Http\Message\StreamInterface|(callable&object)|\Iterator|\Stringable)
    ...
    /**
     * cookies: (false|OCA\Notifications\Vendor\GuzzleHttp\Cookie\CookieJarInterface, default=false)
    ...
    /**
     * sink: (resource|string|\OCA\Notifications\Vendor\Psr\Http\Message\StreamInterface) Where the data
