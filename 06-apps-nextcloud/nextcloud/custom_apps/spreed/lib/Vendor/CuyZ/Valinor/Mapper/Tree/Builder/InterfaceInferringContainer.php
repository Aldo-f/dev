...
final class InterfaceInferringContainer
{
    ...
    public function __construct(private FunctionsContainer $functions, private TypeParser $typeParser)
    {
    }
    /**
    ...
    public function inferClassFor(string $name, array $arguments): ClassType
    {
        ...
        return $implementations[$class] ?? throw new ObjectImplementationNotRegistered($class, $name, $implementations);
    }
    /**
     * @param class-string $name
