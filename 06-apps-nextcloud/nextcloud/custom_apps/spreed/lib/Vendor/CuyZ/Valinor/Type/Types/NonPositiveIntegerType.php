...
final class NonPositiveIntegerType implements IntegerType
{
    ...
    {
        return !is_bool($value) && filter_var($value, FILTER_VALIDATE_INT) !== false && $value <= 0;
    }
    ...
    {
        return MessageBuilder::newError('Value {source_value} is not a valid non-positive integer.')->withCode('invalid_non_positive_integer')->build();
    }
