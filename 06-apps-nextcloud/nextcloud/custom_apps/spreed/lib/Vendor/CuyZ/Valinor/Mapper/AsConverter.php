 ...
 * method can be used: {@see \OCA\Talk\Vendor\CuyZ\Valinor\MapperBuilder::registerConverter()}
 *
 * ```
 * namespace My\App;
 *
 * #[\OCA\Talk\Vendor\CuyZ\Valinor\Mapper\AsConverter]
 ...
 * }
 *
 * $user = (new \OCA\Talk\Vendor\CuyZ\Valinor\MapperBuilder())
 *     ->mapper()
 *     ->map(User::class, [
 *         'name' => 'John Doe',
 *         'isActive' => 'yes',
 ...
 * };
 *
 * $arguments = (new \OCA\Talk\Vendor\CuyZ\Valinor\MapperBuilder())
 *     ->argumentsMapper()
