...
use OCA\Notifications\Vendor\GuzzleHttp\BodySummarizer;
use OCA\Notifications\Vendor\GuzzleHttp\BodySummarizerInterface;
use OCA\Notifications\Vendor\Psr\Http\Client\RequestExceptionInterface;
...
class RequestException extends TransferException implements RequestExceptionInterface
{
    ...
    public static function create(RequestInterface $request, ?ResponseInterface $response = null, ?\Throwable $previous = null, array $handlerContext = [], ?BodySummarizerInterface $bodySummarizer = null): self
    {
        ...
        $uri = \OCA\Notifications\Vendor\GuzzleHttp\Psr7\Utils::redactUserInfo($request->getUri());
