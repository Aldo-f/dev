...
use OCA\Talk\Vendor\CuyZ\Valinor\Normalizer\Transformer\Compiler\TransformerRootNode;
...
final class CompiledTransformer implements Transformer
{
    ...
    public function transform(mixed $value): mixed
    {
        ...
        $key = "transformer-\x00" . $type->toString();
    ...
    private function compileFor(Type $type): string
    {
        ...
        $node = Node::shortClosure($rootNode)->witParameters(Node::parameterDeclaration('transformers', 'array'), Node::parameterDeclaration('delegate', Transformer::class));
