#!/usr/bin/env python3
"""
Verification script for form-automation script.
Tests non-reCAPTCHA functionality: counter persistence, selectors, imports, instantiation.
"""
...
counter_file = SCRIPT_DIR / "data" / "counter.json"
...
try:
    from auto_form import FormAutomation, main
...
try:
    ...
    print("  ✅ FormAutomation instantiates correctly")
except Exception as e:
