...
final class StringValueType implements StringType, FixedType
{
    ...
    {
        return (is_string($value) || is_numeric($value) || $value instanceof Stringable) && (string) $value === $this->value;
    }
    ...
    {
        return MessageBuilder::newError('Value {source_value} does not match string value {expected_value}.')->withCode('invalid_string_value')->withParameter('expected_value', ValueDumper::dump($this->value))->build();
    }
