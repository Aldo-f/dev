...
final class Settings
{
    ...
    {
        return [Constructor::class, DynamicConstructor::class, FromBody::class, FromQuery::class, FromRoute::class, ...array_keys($this->mapperConverterAttributes), ...array_keys($this->normalizerTransformerAttributes)];
    }
    /**
    ...
    {
        return array_values([$this->exceptionFilter, ...$this->inferredMapping, ...$this->customConstructors, ...array_merge(...$this->mapperConverters), ...array_merge(...$this->normalizerTransformers), ...$this->keyConverters]);
    }
}