...
final class NormalizerBuilder
{
     ...
     * }
     *
     * (new \OCA\Talk\Vendor\CuyZ\Valinor\NormalizerBuilder())
     *     ->withCache($cache)
     *     ->normalizer(\OCA\Talk\Vendor\CuyZ\Valinor\Normalizer\Format::json())
     *     ->normalize($someData);
     * ```
     *
     * @pure
     ...
     *     the attribute: {@see \OCA\Talk\Vendor\CuyZ\Valinor\Normalizer\AsTransformer}
     *
     * Example:
     *
     * ```
