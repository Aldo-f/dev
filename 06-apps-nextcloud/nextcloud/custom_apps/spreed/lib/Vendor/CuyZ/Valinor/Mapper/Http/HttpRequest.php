...
namespace OCA\Talk\Vendor\CuyZ\Valinor\Mapper\Http;

use OCA\Talk\Vendor\CuyZ\Valinor\Mapper\Exception\PsrRequestParsedBodyIsObject;
 ...
 *
 * ```
 * $request = \OCA\Talk\Vendor\CuyZ\Valinor\Mapper\Http\HttpRequest::fromPsr(
