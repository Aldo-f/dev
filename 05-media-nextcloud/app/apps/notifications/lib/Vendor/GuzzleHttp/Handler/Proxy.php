...
use OCA\Notifications\Vendor\GuzzleHttp\RequestOptions;
...
class Proxy
{
    ...
    {
        return isset($options[RequestOptions::CRYPTO_METHOD]) && $options[RequestOptions::CRYPTO_METHOD] === \STREAM_CRYPTO_METHOD_TLSv1_2_CLIENT && !CurlVersion::supportsTls12();
    }
}